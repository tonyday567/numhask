...
instance (KnownNat m, KnownNat n, AdditiveMonoidal a) =>
         AdditiveMonoidal (Matrix m n a)
...
instance (KnownNat m, KnownNat n, MultiplicativeMagma a) =>
         MultiplicativeMagma (Matrix m n a) where
  times = liftR2 times

instance (KnownNat m, KnownNat n, MultiplicativeUnital a) =>
         MultiplicativeUnital (Matrix m n a) where
  one = singleton one

instance (KnownNat m, KnownNat n, MultiplicativeAssociative a) =>
         MultiplicativeAssociative (Matrix m n a)

instance (KnownNat m, KnownNat n, MultiplicativeCommutative a) =>
         MultiplicativeCommutative (Matrix m n a)

instance (KnownNat m, KnownNat n, MultiplicativeInvertible a) =>
         MultiplicativeInvertible (Matrix m n a) where
  recip = fmapRep recip

instance (KnownNat m, KnownNat n, MultiplicativeMonoidal a) =>
         MultiplicativeMonoidal (Matrix m n a)

instance (KnownNat m, KnownNat n, Multiplicative a) =>
         Multiplicative (Matrix m n a)

instance (KnownNat m, KnownNat n, MultiplicativeGroup a) =>
         MultiplicativeGroup (Matrix m n a)

instance (KnownNat m, KnownNat n, MultiplicativeMagma a, Additive a) =>
         Distribution (Matrix m n a)
...
instance (KnownNat m, KnownNat n, BoundedField a) =>
         BoundedField (Matrix m n a) where
...
instance (ExpField a) => Normed (Matrix m n a) a where
